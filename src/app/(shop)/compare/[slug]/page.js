...
const CompareClient = dynamic(() => import('../../Components/CompareComponents/CompareClient'), { ssr: true, loading: () => <div className="min-h-[500px] w-full animate-pulse bg-zinc-900 rounded-xl mt-4" /> });

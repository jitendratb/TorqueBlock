...
export const metadata = {
  title:
    'Returns & Refund Policy | Torque Block Premium Motorcycle Tyres',

  description:
    'Read Torque Block’s returns, cancellations, replacement, and refund policy for premium motorcycle tyres including eligibility conditions, refund timelines, warranty guidelines, and reverse logistics terms.',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Torque Block returns, replacement, cancellation, and refund policy for premium motorcycle tyres.',
            publisher: {
              '@type': 'Organization',
              name: 'Torque Block'
            }

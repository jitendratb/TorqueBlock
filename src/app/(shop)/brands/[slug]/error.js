...
export default function BrandSlugErrorBoundary({ error, reset }) {
    ...
    <div className="min-h-[70vh] flex flex-col justify-center items-center py-16 md:py-24 px-4 relative">
      ...
      <div className="w-full max-w-2xl bg-zinc-950 border border-zinc-900 rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 text-center shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden z-10 animate-fade-in">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-none mb-4">
          BRAND CATALOG <span className="text-red-500">DISRUPTION</span>
        </h2>
        
        <p className="text-zinc-500 text-sm md:text-base font-semibold max-w-md mx-auto mb-10 leading-relaxed">
          {"An anomaly occurred while accessing this manufacturer's landing compound directory. The systems have isolated the fault to safeguard parameters."}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          ...
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-850 text-zinc-300 hover:text-white font-black uppercase tracking-widest text-xs md:text-sm rounded-xl md:rounded-2xl transition-all duration-300 cursor-pointer"
          >

...
export default function TubeCardSkeleton({ className = '' }) {
    return (
        <div 
            ...
            <div className="flex flex-col p-4 gap-3 flex-1 justify-between">
                <div className="space-y-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="w-12 h-4 bg-white/5 border border-white/10 rounded-md" />
                    </div>
                ...
                <div className="flex items-end justify-between gap-2 pt-3 border-t border-white/10">
                    ...
                    <div className="w-24 h-9 rounded-lg bg-white/5 border border-white/10" />
                </div>
            </div>
        </div>
    );

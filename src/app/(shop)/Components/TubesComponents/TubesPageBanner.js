...
export default function TubesPageBanner() {
    return (
        <div className="relative w-full h-48 md:h-60 rounded-3xl overflow-hidden flex items-center justify-between px-6 border border-white/10 bg-white/10 [.light-mode_&]:bg-white/60 [.light-mode_&]:border-zinc-200 backdrop-blur-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-orange-500/20 [.light-mode_&]:bg-orange-500/10 rounded-full blur-[80px] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-2xl">
                ...
                <h1 className="text-2xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-orange-500 bg-[length:200%_auto] bg-left group-hover:bg-right transition-[background-position] duration-700 ease-out uppercase tracking-tighter leading-none drop-shadow-md line-clamp-2">
                    Motorcycle Tubes
                </h1>

                <p className="text-zinc-400 [.light-mode_&]:text-zinc-500 text-sm mt-4 max-w-md leading-relaxed font-light">
                    Engineered for durability and safety. Discover the perfect heavy-duty tubes for your journey.
                </p>
            </div>
            ...
            <div className="relative z-10 hidden md:flex gap-5 items-center mr-4">
                ...
                <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-orange-500/20 to-orange-500/5 border border-orange-500/30 flex items-center justify-center backdrop-blur-2xl shadow-[0_0_40px_rgba(249,115,22,0.2)] transition-transform hover:-translate-y-2 duration-500">
                    <FiSettings size={44} className="text-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.4)]" />
                </div>
            </div>
        </div>
    );
